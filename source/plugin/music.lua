...
photo = "https://t.me/d_b_b_y/6"
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Text = "*╭──── •*[ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗚𝗡𝗔𝗭𝗛⇖](t.me/SOURCE_GNAZH )*• ────╮\n├ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗚𝗡𝗔𝗭𝗛⇖  قم بختيار نوع الاغنيه 🎧\n╰───── •*[ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗚𝗡𝗔𝗭𝗛⇖ ](t.me/SOURCE_GNAZH )*• ─────╯\n✦ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗚𝗡𝗔𝗭𝗛 𝑩𝒆𝑻𝑻𝒓 ⏎*"
keyboard = {} 
