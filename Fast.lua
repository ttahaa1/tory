...
LuaTele = luatele.set_config{api_id=26957529,api_hash='ffe7d862b0a31893682a62bbc0654ced',session_name=Fast,token=Token}
function var(value)
...
local Info_User = Redis:get(Fast.."Twasl:UserId"..Message_Get.forward_info.date) or 5512718660
if text == 'حظر' then
...
local T = "*⚡ مـرحـبا انـا صـانـع بـوتـات\n⚡ اقوم بصنع بوتات حمايه\n⚡ تم برمجتي من قبل المطور جنازه\n⚡ للتنصيب الحمايه ارسل /vega\n⚡ او اتبع الازرار بالاسفل*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '⚡جنازه⚡', url = 't.me/GNA_I'},
},
{
{text = '⚡ جنازه⚡', url = 't.me/SOURCE_GNAZH'},
},
...
video = "https://t.me/sourcevega2/13"
local T =[[*
▱▰▱▰▱▰▱▰▱▰▱▰▱▰
...
keyboard.inline_keyboard = {
{
{text = '⚡جنازه⚡', url = "https://t.me/GNA_I"}
},
{  
{text = '⚡ جنازه⚡', url = 't.me/SOURCE_GNAZH '},
},
...
photo = "https://t.me/d_b_b_y/5"
local T =[[
 [⚡𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐈𝐍 𝐒𝐎𝐔𝐑𝐂𝐄 𝗚𝗡𝗔𝗭𝗛⚡](t.me/SOURCE_GNAZH )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == '⚡ مبرمج السورس' or text == 'جنازه' then
photo = "https://t.me/d_b_b_y/5"
local T =[[
 [⚡DEVELOPAR ɢ ɴ ᴀ ᴢ ʜ ™ 𝓼⚡](t.me/GNA_I )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
keyboard.inline_keyboard = {
{
{text = Text, url = 't.me/SOURCE_GNAZH '},
},
}
local msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo="..photo.."&caption=".. URL.escape(JABWA).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
